...
>>__Most of the participants had never seen their data in spreadsheet format and viewing the data in such a way helped think about the data and what it represents.__ 
...
>> Most importantly though, __the museum partners helped us to better filter the datasets and improve the parameters we are using to cluster the object data__. 

We now have a much better idea on how to proceed with the project
